...
const songs = [
    {
        id : "1",
        songName : `Shrivalli <br> <div class="subtitle"> Sid Shri Ram</div>`,
        poster : `img/1.jpg`
    },
    {
        id : "2",
    ...
    {
        id : "4",
        songName : `Khamosiyan <br> 
                    <div class="subtitle"> Arijit Singh</div>`,
        poster : `img/4.jpg`
    },
    {
        id : "5",
        songName : `Aangaron <br> 
                    <div class="subtitle"> Shreya Ghosala </div>`,
        poster : `img/5.jpg`
    },
    {
        id : "6",
    ...
    },
    {
        id : "7",
        songName : `Saami <br> 
                    <div class="subtitle"> Shaan & Clinton</div>`,
        poster : `img/7.jpg`
    },
    {
        id : "8",
        songName : ` Aankh Maare <br> 
    ...
    },
    {
        id : "16",
        songName : `Tum Tum <br> 
                            <div class="subtitle"> Vishal Arya</div>`,
        poster : `img/16.jpg`
    },
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        ...
        makeAllBackground();
        Array.from(document.getElementsByClassName('songItem'))[index-1].style
        makeAllPlays();
